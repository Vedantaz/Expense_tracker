...
import { FormControl, RadioGroup, FormControlLabel, Radio, Box, Typography, TextField, } from "@mui/material";

const categoryGroup = ({ expenseName, setName, amount, setAmt, category, setCat, handleadd }) => {
